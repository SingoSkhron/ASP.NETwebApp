...
namespace Infrastructure.Repositories
{
    public class GroupRepository : IGroupRepository
    {
        ...
        public Task<bool> Update(Group group)
        {
            ...
            groupToUpdate.HigherEducationLevel = group.HigherEducationLevel;
            groupToUpdate.FormOfEducation = group.FormOfEducation;
            groupToUpdate.YearOfAdmission = group.YearOfAdmission;
            return Task.FromResult(true);
        }
        private void PopulateTestData()
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                group.HigherEducationLevel = "Специалитет";
                group.FormOfEducation = "Очное";
                group.YearOfAdmission = 2020;
            }
        }
    }
}
